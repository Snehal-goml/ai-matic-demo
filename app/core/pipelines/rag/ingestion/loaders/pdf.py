...
class PDFLoader(DocumentLoader):
    ...
    def _check_dependencies(self):
        ...
        try:
            import pypdf  # modern successor of PyPDF2
            self._pypdf_available = True
            logger.debug("pypdf is available.")
        except ImportError:
            self._pypdf_available = False
            logger.debug("pypdf is NOT available.")
        ...
        if not self._pypdf_available and not self._pypdf2_available and not self._pdfplumber_available:
            logger.warning(
    ...
    async def load(self, source: str) -> List[Document]:
        ...
        try:
            ...
            elif self._pypdf_available or self._pypdf2_available:
                logger.info("Using pypdf/PyPDF2 for PDF extraction.")
